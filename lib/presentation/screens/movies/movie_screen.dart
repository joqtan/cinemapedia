...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    super.initState();
    ref.read(moviesDetailProvider.notifier).loadMovie(widget.movieId);
  }

  @override
  Widget build(BuildContext context) {
    final Movie? movie = ref.watch(moviesDetailProvider)[widget.movieId];
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        title: Text(movie.title, style: TextStyle(color: Colors.white, fontSize: 20), textAlign: TextAlign.start),
        background: Stack(
          children: [
